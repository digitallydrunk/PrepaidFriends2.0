            ...
            <div className="lg:col-span-5">
              <div className="p-6 rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="lg:col-span-6">
                  ...
                  <div>
                    ...
                    <div className="lg:col-span-6">
                     <p className="font-bold">Envice ID</p>
                  ...
                  <div className=" flex items-center justify-between">
                   <div className="flex">
                    <img width={110} src="https://prepaidfriends.com/static/media/Visacartpage.09617a67e50bb7c4004c.png"/>
             ...
             <h3 className="leading-normal font-bold mt-6">
              ...
              <h3 className="font-bold ">
                ...
                <div className=" flex justify-between  mt-2 lg:col-span-3">
                 <p>$5.52</p>
                 <p>0.00153965BTC</p>
                </div>
