...
const PFCheckbox = ({ id, label,htmlFor ,checked, onChange, disabled,...props }) => (
  <div className="flex items-center mb-0">
    <input
      ...
      {...props}
    />
    <label className={`form-checkbox-label text-slate-400 ${disabled ? 'text-gray-400' : ''}`} htmlFor={htmlFor}>
      {label}
    </label>
  </div>
);
