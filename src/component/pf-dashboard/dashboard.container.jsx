                ...
                >
                  ...
                  <li role="presentation">
                    <li role="presentation">
                      ...
                      >
                        <IoIosArrowDropdownCircle className="text-[20px] me-2 align-middle" />
                        Orders
                      </button>
                      {isOpenAccordion && (
                        <div className={styles.accordioncontent}>
                          ...
                          <p className={styles.bulk} onClick={() => handleTabClick(2)}>Bulk Order</p>
                        </div>
                      )}
                    </li>
                  </li>
    ...
    return (
      ...
      {isOpenAccordion && (
        <div className="accordion-content">
          ...
          isOpenAccordion
            ? 'text-black bg-indigo-600 hover:text-white'
            : ''
        } px-4 py-2 text-start font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out flex items-center `}>Individual Order</button>
            <button onClick={() => handleTabClick(2)} className={`${
          isOpenAccordion
            ? 'text-black bg-indigo-600 hover:text-white'
            : ''
        } px-4 py-2 text-start font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out flex items-center`}>Bulk Order</button>
                        ...
                        <div className="lg:col-span-9 md:col-span-7">
                            <div id="myTabContent" className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                                ...
                                {isOpenTab === 1 ? <div id="order" role="tabpanel" aria-labelledby="order-tab">
                                    <div className="relative overflow-x-auto shadow dark:shadow-gray-800 rounded-md">
                                        <h1 className='bg-slate-50 dark:bg-slate-800 gap-6 text-center font-extrabold text-4xl mb-10'>Individual    Order</h1>
                                        <table className="w-full text-start text-slate-500 dark:text-slate-400">
                                            <thead className="text-sm uppercase bg-slate-50 dark:bg-slate-800">
                                                <tr className="text-start">
                                ...
                                {isOpenTab === 2 ? <div id="order" role="tabpanel" aria-labelledby="order-tab">
                                    <div className="relative overflow-x-auto shadow dark:shadow-gray-800 rounded-md">
                                    <h1 className='bg-slate-50 dark:bg-slate-800 gap-6 text-center font-extrabold text-4xl mb-10'>Bulk Order</h1>
                                        <table className="w-full text-start text-slate-500 dark:text-slate-400">
                                            <thead className="text-sm uppercase bg-slate-50 dark:bg-slate-800">
                                                <tr className="text-start">
                                                    <th scope="col" className="px-2 py-3 text-start">Order no.</th>
